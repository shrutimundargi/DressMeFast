...
public class Main {
    /* test */
    /*
     * public static void main(String[] args){ Controller cont =
     * ControllerImpl.getInstance(); System.out.println(cont.signUp("pop",
     * "palla")); System.out.println(cont.signUp("pop", "palla"));
